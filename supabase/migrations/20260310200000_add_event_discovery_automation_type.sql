-- Add event_discovery to ai_automations automation_type CHECK constraint
...
ALTER TABLE ai_automations ADD CONSTRAINT ai_automations_automation_type_check
  CHECK (automation_type IN ('paper_search', 'news_collection', 'custom', 'hp_post', 'event_discovery'));
